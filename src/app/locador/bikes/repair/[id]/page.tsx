...
import style from "./rapair.module.css";
  ...
  const id = Number(params.id); 
    ...
    return (
        <main className={style.rapair}>
            <div className={style.menu_2}>
              <Menu />
            </div>
            <div className={style.repair_center_content_2}>
              <div className={style.content_container_2}>
                  ...
                  <div className={style.image_container}>
                      <Image className={style.imageBike_2} src={bikeSelected.imagePath} alt="Bike Image" width={450} height={450} />
                  </div>
                  <div className={style.status_container_2}>
